...
@Entity
@Table(name = "petsperdido")
public class PetPerdidoModel {
    ...
    @Column(name = "imagem")
    @Lob
    private byte[] imagemPerdido;

   
    public byte[] getImagemPerdido() {
        return imagemPerdido;
    }

    public void setImagemPerdido(byte[] imagemPerdido) {
        this.imagemPerdido = imagemPerdido;
    }
